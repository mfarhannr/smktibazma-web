                    ...
                    <div class="container-fluid px-0 phenomena-bold">
                        ...
                        <a href="/team" class="dropdown-item border-radius-md">
                          ...
                          Account
                                ...
                                <li class="nav-item dropdown dropdown-hover mx-2">
                                    <a href="/profil"
                                        class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center btn bg-gradient-info text-white"
                                        style="font-size: 18px">Login</a>
                                    <a class="btn bg-gradient-info text-white" href="/profil">Selengkapnya</a>
