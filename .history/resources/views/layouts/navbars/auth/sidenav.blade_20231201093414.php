            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#kesiswaan" class="nav-link" aria-controls="kesiswaan"
                        ...
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="ni ni-archive-2 text-dark text-sm opacity-10" aria-hidden="true"></i>
                        </div>
                ...
                <li class="nav-item">
                    <a class="nav-link {{ str_contains(request()->url(), 'admin-ppdb') == true ? 'active' : '' }}"
                        href=
                    "{{ route('page', ['page' => 'admin-ppdb']) }}">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="ni ni-book-book-mar text-dark text-sm opacity-10"></i>
                        </div>
