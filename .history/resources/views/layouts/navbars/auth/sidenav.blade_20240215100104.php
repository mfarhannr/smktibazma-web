<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'admin-management' ? 'active' : '' }}"
                    href="{{ route('admin-managemnt') }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#kesiswaan" class="nav-link " aria-controls="kesiswaan" role="button"
                    aria-expanded="true">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-folder-17 text-dark text-sm opacity-10" aria-hidden="true"></i>
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#Resume" class="nav-link " aria-controls="Resume" role="button"
                    aria-expanded="true">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-folder-17 text-dark text-sm opacity-10" aria-hidden="true"></i>
                ...
                <div class="collapse show " id="Resume" style="">
                    <ul class="nav ms-4">
                        <li class="nav-item ">
