    <aside
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#kesiswaan" class="nav-link active text-dark" aria-controls="kesiswaan"
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#katalog-talenta" class="nav-link " aria-controls="katalog-talenta"
                        role="button" aria-expanded="true">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="ni ni-folder-17 text-dark text-sm opacity-10"
                                aria-hidden="true"></i>
                        </div>
                        <span class="nav-link-text ms-1">katalog talenta</span>
                    </a>
                    <div class="collapse show " id="katalog-talenta" style="">
                        <ul class="nav ms-4">
                            <li class="nav-item ">
                                <a class="nav-link {{ str_contains(request()->url(), 'admin-talent') == true ? 'active' : '' }} "
                                    href="{{ route('page', ['page' => 'admin-talent']) }}">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link {{ str_contains(request()->url(), 'admin-portfolio') == true ? 'active' : '' }} "
                                    ...
                                    <span class="sidenav-normal ps-2">Portofolio</span>
                                </a>
                            </li>
                        </ul>
                    </div>
