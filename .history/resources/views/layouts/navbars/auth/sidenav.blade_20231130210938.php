...
<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#kesiswaanj" class="nav-link "
                    aria-controls="kesiswaanj" role="button" aria-expanded="true">
                ...
                <div class="collapse show " id="kesiswaanj" style="">
                    <ul class="nav ms-4">
                        <li class="nav-item ">
                            <a class=" d-flex nav-link {{ str_contains(request()->url(), 'admin-kegiatan') == true ? 'active' : '' }} "
                                href="{{ route('page', ['page' => 'admin-kegiatan']) }}">
                                <span class="sidenav-normal">Kegiatan </span>
                            </a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link {{ str_contains(request()->url(), 'admin-prestasi') == true ? 'active' : '' }} "
