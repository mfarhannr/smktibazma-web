                        ...
                        <div class="col-md">
                            ...
                            <div class="mt- text-justify">
                                ...
                                <p style="font-weight:500">
                                    DAFTAR SEGERA! Penerimaan Peserta Didik Baru (PPDB) Islamic Boarding school SMK TI BAZMA TP 2024/2025
                                </p>
                                <p >
                        ...
                        <div class="card">
                            <div class="accordion p-3 text-justify" id="accordionPricing">
                                <div class="accordion-item mb-3">
                                    <h3 class="accordion-header phenomena-bold" id="headingOne" style="font-size: 50px;">
                                    ...
                                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                        ...
                                        <div class="accordion-body">
                                            <ol style="text-align: justify">
                                                ...
                                                <li>Surat rekomendasi Kepala Sekolah/Wali Kelas/Guru SMP (Download Template);</li>
                                                ...
                                                <li>
                                                   Membuat esai/karangan bebas tentang “Peran saya sebagai pemuda di Era Digital” (Download Ketentuan);
                                                </li>
