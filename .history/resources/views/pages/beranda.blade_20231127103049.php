            ...
            <div class="container px-3">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center mx-auto my-auto">
                        <h1 class="text-md-white phenomena-bold" style="font-size: 65px">
                            SMK TI BAZMA
                        </h1>
                        <p class="lead mb-4 text-md-white opacity-8">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg">
                        <div class="col-md d-flex justify-content-end">
                            <img src="./template/assets/img/bruce-mars.jpg" class="img-fluid" alt="Image Kepala Sekolah">
                        </div>
