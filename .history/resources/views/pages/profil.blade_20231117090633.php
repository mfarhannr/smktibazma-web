              ...
              <div class="col-md">
                  ...
                  <div class="col-lg-6 my-auto">
                    <div class="cursor-pointer">
                      <div class="card card-background">
                        <div class="full-background" style="background-image: url(.TEMPLAT/assets/img/examples/asrama.jpg)" loading="lazy">
                        </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6 my-auto">
                    <div class="cursor-pointer">
                      <div class="card card-background">
                        <div class="full-background" style="background-image: url('./assets/img/examples/masjid.jpg')" loading="lazy">
                        </div>
                        <div class="card-body py-7 text-center">
