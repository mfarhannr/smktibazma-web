                    ...
                    <div class="col-lg-8 me-auto py-5 my-auto text-start text-justify">
                      <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade show active" id="heksagon" role="tabpanel"
                          ...
                          <img class="width-32-px mb-3" src="./pages/assets/img/examples/hexagon.png" alt="logo">
                          <p>
                        ...
                        <div class="tab-pane fade" id="rumah" role="tabpanel" aria-labelledby="rumah-tab">
                          <img class="width-32-px mb-3" src="./pages/assets/img/examples/rumah.png" alt="logo">
                          <p>
                        ...
                        <div class="tab-pane fade" id="orang" role="tabpanel" aria-labelledby="orang-tab">
                          <img class="width-32-px mb-3" src="./pages/assets/img/examples/orang.png" alt="logo">
                          <p>
                        ...
                        <div class="tab-pane fade" id="huruf" role="tabpanel" aria-labelledby="huruf-tab">
                          <img class="width-32-px mb-3" src="./pages/assets/img/examples/huruf.png" alt="logo">
                          <p>
                    ...
                    <div class="col-lg-8 me-auto my-auto text-start text-justify">
                      <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade show active" id="biru" role="tabpanel" aria-labelledby="biru-tab">
                          <img class="width-32-px mb-3" src="./pages/assets/img/examples/biru.png" alt="logo">
                        ...
                        <div class="tab-pane fade" id="hijau" role="tabpanel" aria-labelledby="hijau-tab">
                          <img class="width-32-px mb-3" src="./pages/assets/img/examples/hijau.png" alt="logo">
                        ...
                        <div class="tab-pane fade" id="merah" role="tabpanel" aria-labelledby="merah-tab">
                          <img class="width-32-px mb-3" src="./pages/assets/img/examples/merah.png" alt="logo">
                    ...
                    <div class="row">
                        ...
                        <div class="card mt-5 mt-md-0">
                          <div class="card-header p-0 mx-3 mt-n4 position-relative z-index-2">
                            <a class="d-block blur-shadow-image">
                              <img src="./pages/assets/img/examples/kelas.jpg" alt="img-blur-shadow"
                      ...
                      <div class="col-lg-3 col-md-6">
                        <div class="card mt-5 mt-md-0">
                          <div class="card-header p-0 mx-3 mt-n4 position-relative z-index-2">
                            <a class="d-block blur-shadow-image">
                              <img src="./pages/assets/img/examples/masjid.jpg" alt="img-blur-shadow"
                                class="img-fluid border-radius-lg" loading="lazy" />
                            </a>
                            <div class="colored-shadow" style="
                                  background-image: url('./pages/assets/img/examples/masjid.jpg');
                                "></div>
                          </div>
                          <div class="card-body pt-3 text-center">
                            <a href="javascript:;">
                      ...
                      <div class="col-lg-3 col-md-6">
                        <div class="card mt-5 mt-md-0">
                          <div class="card-header p-0 mx-3 mt-n4 position-relative z-index-2">
                            <a class="d-block blur-shadow-image">
                              <img src="./pages/assets/img/examples/asrama.jpg" alt="img-blur-shadow"
                                class="img-fluid border-radius-lg" loading="lazy" />
                            </a>
                            <div class="colored-shadow" style="
                                  background-image: url('./pages/assets/img/examples/asrama.jpg');
                      ...
                      <div class="col-lg-3 col-md-6">
                        <div class="card mt-5 mt-md-0">
                          <div class="card-header p-0 mx-3 mt-n4 position-relative z-index-2">
                            <a class="d-block blur-shadow-image">
                              <img src="./pages/assets/img/examples/lapangan.jpg" alt="img-blur-shadow"
                                class="img-fluid border-radius-lg" loading="lazy" />
                            </a>
                            <div class="colored-shadow" style="
                                  background-image: url('./pages/assets/img/examples/lapangan.jpg');
                                "></div>
                          </div>
                          <div class="card-body pt-3 text-center">
                            <a href="javascript:;">
                      ...
                      <img src="./pages/assets/img/examples/fasilitas.png" class="mt-5" />
                    </div>
                  </div>
                </section>
              </div>
