                    ...
                    <div class="row">
                                    ...
                                    <form role="form" method="POST" action="{{ route('login.perform') }}">
                                        ...
                                        <div class="flex flex-col mb-3">
                                            <input type="username" name="username" class="form-control form-control-lg"
                                                aria-label="Username" value="secret">
                                            @error('username')
                                        ...
                                        <div class="flex flex-col mb-3">
                                            <input type="role" name="password" class="form-control form-control-lg"
                                                aria-label="Password" value="secret">
                                            @error('password')
                                                <p class="text-danger text-xs pt-1"> {{ $message }} </p>
                                            @enderror
                        ...
                        <div
                            ...
                            <div class="position-relative bg-gradient-dark h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden"
                                ...
                                <h4 class="mt-5 text-white font-weight-bolder position-relative">SMK TI Bazma</h4>
                                <p class="text-white position-relative">Buat Website Lebih menarik dan dinamis</p>
                            </div>
                        </div>
                    </div>
                </div>
