        ...
        <div class="col-12">
            ...
            <div class="card mb-4">
                ...
                <div class="card-header pc-0 d-flex mb-0 justify-content-between">
                    ...
                    <a href="/admin/prestasi/create" class=" me-7 text-center mb-0 btn bg-gradient-dark btn-sm">Add Prestasi</a>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            <div class="d-flex justify-content-center align-items-center">
                                                <form action="page-prestasi{{ $item->id }}/edit" method="PUT"
                                                ...
                                                <form action="page-prestasi{{ $item->id }}" method="POST">
                                                    @csrf
                                                    @method('delete')
