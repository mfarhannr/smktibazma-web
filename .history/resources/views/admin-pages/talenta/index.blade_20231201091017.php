        ...
        <div class="col-12">
            ...
            <div class="card mb-4">
                ...
                <div class="card-header pc-0 d-flex justify-content-between">
                    ...
                    <a href="/alogtalenta/create" class="btn bg-gradient-dark btn-sm mx-8">Add katalogtalenta</a>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-end">
                                            <div class="d-flex px-3 py-1 justify-content-center align-items-center">
                                                <a href="/alogtalenta/{{ $item->id }}/edit" class="me-3"
                                                    data-bs-toggle="tooltip" data-bs-original-title="Edit katalogtalenta">
                                                    <i class="fas fa-user-edit text-secondary" aria-hidden="true"></i>
                                                </a>
                                                <form action="/alogtalenta/{{ $item->id }}" method="POST">
                                                    @csrf
                                                    @method('delete')
                                                    <button
