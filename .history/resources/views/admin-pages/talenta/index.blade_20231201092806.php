        ...
        <div class="col-12">
            ...
            <div class="card mb-4">
                ...
                <div class="card-header pc-0 d-flex justify-content-between">
                    ...
                    <a href="/admin-katalogtalenta/create" class="btn bg-gradient-dark btn-sm ">Add katalogtalenta</a>
                </div>
                    ...
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    <th
                                        class="text-center  ps-2 text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">
                                        id
                                    </th>
                                    <th
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-end">
                                            <div class="d-flex px-3 py-1 justify-content-center align-items-center">
                                                ...
                                                <form action="/admin-katalogtalenta/{{ $item->id }}" method="POST">
                                                    @csrf
                                                    @method('delete')
                                                    <button
