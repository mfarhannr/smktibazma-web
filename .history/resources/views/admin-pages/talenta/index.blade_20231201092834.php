        ...
        <div class="col-12">
            ...
            <div class="card mb-4">
                ...
                <div class="card-header pc-0 d-flex justify-content-between">
                    <h6 class="mb-0">katalogtalenta</h6>
                    <a href="/adminatalogtalenta/create" class="btn bg-gradient-dark btn-sm ">Add katalogtalenta</a>
                </div>
                    ...
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    <th
                                        class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 px-56">
                                        id
                                    </th>
                                    <th
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-end">
                                            <div class="d-flex px-3 py-1 justify-content-center align-items-center">
                                                <a href="/adminatalogtalenta/{{ $item->id }}/edit" class="me-3"
                                                    data-bs-toggle="tooltip" data-bs-original-title="Edit katalogtalenta">
                                                    <i class="fas fa-user-edit text-secondary" aria-hidden="true"></i>
                                                </a>
                                                <form action="/adminatalogtalenta/{{ $item->id }}" method="POST">
                                                    @csrf
                                                    @method('delete')
                                                    <button
