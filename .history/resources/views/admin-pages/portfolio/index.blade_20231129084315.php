                    ...
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    <th
                                        class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" style="width: 25%">
                                        Judul
                                    </th>
                                    <th
                                        class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" style="width: 25%">
                                        ...
                                        <td class="align-middle text-center">
                                            <div class="d-flex justify-content-center align-items-center">
                                                <form action="/portfolio/{{ $item->id }}/edit" method="POST"
                                                    ...
                                                    <button class="btn btn-xs btn-danger mb-0 font-weight-bold text-xs">
                                                        <span class="btn-inner--icon"><i
                                                                class="fa-regular fa-pen-to-square fa-bounce"></i></span>
                                                ...
                                                <form action="/portfolio/{{ $item->id }}" method="POST">
                                                    @csrf
                                                    @method('delete')
                                                    <button class="btn btn-xs btn-info mb-0 font-weight-bold text-xs">
                                                        <span class="btn-inner--icon"><i
