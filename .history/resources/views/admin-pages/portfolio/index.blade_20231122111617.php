        ...
        <div class="col-12">
            ...
            <div class="card mb-4">
                ...
                <div class="card-header pc-0 d-flex justify-content-between">
                    ...
                    <a href="{{ route('portfolio.create') }}" class="btn bg-gradient-dark btn-sm mx-8">Add Portfolio</a>
                </div>
                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                @forelse ($portfolios as $item)
                                    <tr>
                                        <td>
                                            <h6 class="mb-0 mx-2 text-sm">{{ $item->judul }}</h6>

                                        </td>
                                        <td>
                                            <div>
                                                <img src="{{ asset('img/' . $item->gambar) }}" class="border-radius-lg shadow-sm height-100 w-auto"
                                                    alt="">
                                            </div>
                                        </td>
                                        ...
                                        <td class="align-middle text-end">
                                            <div class="d-flex px-3 py-1 justify-content-center align-items-center">
                                                <a href="https://argon-dashboard-pro-laravel.creative-tim.com/category-management/edit/1" class="me-3" data-bs-toggle="tooltip" data-bs-original-title="Edit category">
                                                    <i class="fas fa-user-edit text-secondary" aria-hidden="true"></i>
                                                </a>
                                                <form action="https://argon-dashboard-pro-laravel.creative-tim.com/category-delete/1" method="post">
                                                    <input type="hidden" name="_token" value="OHTFtOQFUPsaDLjcq96049UdygQMv4vXl2grQYvI"> <button onclick="confirm('Are you sure you want to remove the category?') || event.stopImmediatePropagation()" data-bs-toggle="tooltip" data-bs-original-title="Delete category" class="border-0 bg-white">
