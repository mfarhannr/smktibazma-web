                                        ...
                                        <td class="align-middle text-end">
                                            <div class="d-flex px-3 py-1 justify-content-center align-items-center">
                                                <a href="/portfolio/{{ $item->id }}/edit"
                                                    ...
                                                    data-bs-original-title="Edit Portfolio">
                                                    <i class="fas fa-user-edit text-secondary" aria-hidden="true"></i>
                                                </a>
                                                <form
                                                    action="/portfolio/{{ $item->id }}"
                                                    method="delete">
                                                    <input type="hidden" name="_token"
                                                        value="OHTFtOQFUPsaDLjcq96049UdygQMv4vXl2grQYvI"> <button
                                                        onclick="confirm('Are you sure you want to remove the Portfolio?') || event.stopImmediatePropagation()"
                                                        data-bs-toggle="tooltip" data-bs-original-title="Delete Portfolio"
                                                        class="border-0 bg-white" value="">
