        ...
        <div class="col-12">
            ...
            <div class="card mb-4">
                ...
                <div class="card-header pc-0 d-flex justify-content-between">
                    ...
                    <a href="{{ route('portfolio.create') }}" class="btn bg-gradient-dark btn-sm">Add Portfolio</a>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            <div class="d-flex px-3 py-1 justify-content-center align-items-center">
                                                <a href="/portfolio/{{ $item->id }}/edit" class="me-3"
                                                    data-bs-toggle="tooltip" data-bs-original-title="Edit Portfolio">
                                                    <i class="fa-regular fa-pen-to-square fa-bounce" aria-hidden="true"></i>
                                                </a>
                                                <form action="/portfolio/{{ $item->id }}/edit" method="POST"
                                                    class="text-center">
                                                    @csrf
