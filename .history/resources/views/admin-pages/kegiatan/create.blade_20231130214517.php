...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Kegiatan / Create'])
    <div class="container py-8">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="font-weight-bolder mb-0">Add Kegiatan</h5>
                        {{-- <p class="mb-0 text-sm">Mandatory informations</p> --}}
                        <div class="row">
                            <div class="col-md-12 mt-2">
                                <form action="/adminkegiatan" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row mt-3">
