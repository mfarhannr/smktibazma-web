        ...
        <div class="col-12">
            ...
            <div class="card mb-4">
                ...
                <div class="card-header pc-0 d-flex mb-0 justify-content-between">
                    ...
                    <a href="{{ route('kegiatan.create') }}" class=" me-7 text-center mb-0 btn bg-gradient-dark btn-sm">Add Kegiatan</a>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            <div class="d-flex justify-content-center align-items-center">
                                                <form action="/Kegiatan/{{ $item->id }}/edit" method="POST"
