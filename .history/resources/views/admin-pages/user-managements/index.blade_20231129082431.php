                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                @foreach ($user as $item)
                                    <tr>
                                        <td>
                                            <p class="text-center text-sm  mb-0">{{ $item->username }}</p>
                                        </td>
                                        <td>
                                            <p class="text-center text-sm  mb-0">{{ $item->email }}</p>
                                        </td>
                                        <td>
                                            <p class="text-center text-sm  mb-0">{{ $item->role }}</p>
                                        </td>
                                        <td>
                                            <form action="/admin-management/{{ $item->id }}" method="POST" class="text-center">
                                                @csrf
                                                @method('delete')
                                                <button class="btn btn-xs btn-danger mb-0  text-xs">
