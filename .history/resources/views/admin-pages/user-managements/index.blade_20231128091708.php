        ...
        <div class="col-12">
            ...
            <div class="card mb-4">
                ...
                <div class="card-header pc-0 d-flex justify-content-between">
                    ...
                    <a href="{{ route('user-management.create') }}" class="btn bg-gradient-dark btn-sm mx-8">Add Admin</a>
                </div>
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7"></th>Name
                                    </th>
