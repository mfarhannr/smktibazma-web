                                        ...
                                        <td>
                                            <form action="/admin-management/{{ $item->id }}" method="POST"
                                                ...
                                                <button class="btn btn-xs btn-danger mb-0 font-weight-bold text-xs"
                                                    onclick="confirm('Are you sure you want to remove the account?') || event.stopImmediatePropagation()"
                                                    data-bs-toggle="tooltip" data-bs-original-title="Delete Account">
