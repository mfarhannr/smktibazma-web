        ...
        <div class="col-12">
            ...
            <div class="card mb-4">
                ...
                <div class="card-header pc-0 d-flex justify-content-between">
                    <h5 class="ps-5 mb-0 text-center">Admin Management</h5>
                    <a href="{{ route('admin-management.create') }}" class="mb-0 me-8 btn bg-gradient-dark btn-sm text-center">Add Admin</a>
                </div>
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" style="width">
                                        Name
                                    </th>
