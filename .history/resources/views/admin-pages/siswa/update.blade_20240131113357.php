                                        ...
                                        <div class="row">
                                            <div class="col lg 3">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="instagram" value="{{$Siswa->instagram}}"
                                                        onfocus="focused(this)" onfocusout="defocused(this)">
                                                </div>
                                            </div>
                                            <div class="col lg 3">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="linkedin" value="{{$Siswa->linkedin}}"
                                                        onfocus="focused(this)" onfocusout="defocused(this)">
                                                </div>
                                            </div>
                                            <div class="col lg 3">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="github" value="{{$Siswa->github}}"
                                                        onfocus="focused(this)" onfocusout="defocused(this)">
                                                </div>
                                            </div>
                                            <div class="col lg 3">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="file" name="gambar" value="{{$Siswa->gambar}}"
                                                        onfocus="focused(this)" onfocusout="defocused(this)">
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
