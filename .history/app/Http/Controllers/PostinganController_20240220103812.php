...
class PostinganController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to('/eate-postingan')->with('succes', 'Postingan Berhasil Dibuat');
    }
    public function edit($id, Request $request)
    {
        ...
        return redirect()->to('/eate-postingan')->with('succes', 'Postingan Berhasil Diupdate');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->to('/eate-postingan')->with('succes', 'Postingan Berhasil Dihapus');
    }
}
