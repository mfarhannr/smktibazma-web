...
Route::get('/admin-egiatan', [PageController::class, 'kegiatan'])->name('kegiatan');
...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::get('/admin-ategori-postingan', [KategoriPostinganContoller::class, 'kategoriPostingan'])->name('kategori-postingan'); 
	Route::post('/admin-ategori-postingan', [KategoriPostinganContoller::class, 'store'])->name('kategori-store');
	Route::get('/admin-ategori-postingan/{id}', [KategoriPostinganContoller::class, 'show']);
	Route::delete('/admin-ategori-postingan/{id}/delete', [KategoriPostinganContoller::class, 'destroy'])->name('kategori-destroy');
