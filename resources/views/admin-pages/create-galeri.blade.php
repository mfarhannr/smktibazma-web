...
<div class="container-fluid py-4">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <p class="text-uppercase text-sm">+ Foto</p>
                    <div class="row">
                        <div class="col-md-12">
                            <form action="{{ route('create-galeri-store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label for="example-text-input" class="form-control-label">Kategori</label>
                                    <select class="form-select" name="kategori_galeri_id">
                                        <option>---</option>
                                        @foreach ($allCategoryGallery as $item)
                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center text-sm">
                                        <span class="text-secondary text-xs font-weight-bold">{{ $item->kategori_galeri->name }}</span>
                                    </td>
                                    ...
                                    <td class="align-middle text-center">
                                        <form class="d-inline" onsubmit="return confirm('sure to delete this data')"
                                            action="{{ url('create-galeri/' . $item->id . '/delete') }}"
                                            method="post">
                                            @csrf
                                            @method('DELETE')
