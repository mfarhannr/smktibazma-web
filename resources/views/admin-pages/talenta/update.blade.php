                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12 mt-2">
                                <form action='/KatalogTalenta/{{$KatalogTalenta->id}}'method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('put')
                                    <div class="row mt-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="deskripsi" value="{{$KatalogTalenta->deskripsi}}"
                                                onfocus="focused(this)" onfocusout="defocused(this)">
                                        </div>
